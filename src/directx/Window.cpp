...
namespace gfxlib
{
    ...
    void Window::initialise(HINSTANCE hInst, int cmdShow)
    {
        static TCHAR szTitle[] = _T(m_title.c_str());
        static TCHAR szClassName[] = _T("DesktopWindow");

        WNDCLASSEX wcex;
        wcex.cbSize = sizeof(WNDCLASSEX);
        wcex.style = CS_HREDRAW | CS_VREDRAW;
        wcex.lpfnWndProc = std::bind(&Window::ProcessEvents, *this);
        wcex.cbClsExtra = 0;
        wcex.cbWndExtra = 0;
    ...
    LRESULT Window::ProcessEvents(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
    {
        return 0;
    }
}
